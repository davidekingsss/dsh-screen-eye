...
/**
 * The exact stderr `screencapture` writes when TCC refuses the capture. This
 * string is the whole diagnosis: it distinguishes "you are not authorised"
 * from every other failure, which needs a different remedy.
 */
const TCC_DENIAL = 'could not create image from display';
