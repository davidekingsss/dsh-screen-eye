...
/**
 * The C# shim compiled in memory for the length of one engine call.
 *
 ...
 */
const NATIVE = `Add-Type -Namespace DshScreenEye -Name Native -MemberDefinition @'
...
try { ${NATIVE} } catch { Fail '${ENGINE_UNAVAILABLE}' ('the Windows capture helper could not be compiled: ' + $_.Exception.Message) }`;
