...
/**
 * Platforms known to gate capture behind a user-granted permission, i.e. the
 * ones that need the onboarding flow rather than just an error message.
 * @param platform - a `process.platform` value.
 * @returns whether a permission gate applies.
 */
export function hasPermissionGate(platform = process.platform) {
